...
export class RestaurantController {
  ...
  public getRestaurants = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const findAllRestaurants: Restaurant[] = await this.restaurant.findAllRestaurants();
  ...
  public getRestaurantsById = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const findOneRestaurantData: Restaurant = await this.restaurant.findRestaurantsById(restaurantId);
  ...
  public createRestaurant = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const createRestaurantData: Restaurant = await this.restaurant.createRestaurant(restaurantData);
  ...
  public updateRestaurant = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const restaurantId = Number(req.params.id);
      const restaurantData: CreateRestaurantDTO = req.body;
      const updateRestaurantData: Restaurant = await this.restaurant.updateRestaurant(restaurantId, restaurantData);
  ...
  public deleteRestaurant = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const restaurantId = Number(req.params.id);
      const deleteRestaurantData: Restaurant = await this.restaurant.deleteRestaurant(restaurantId);
